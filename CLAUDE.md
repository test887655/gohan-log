...
### 見た目
- 「シンプル」と「かわいい」の2種類。ヘッダーのボタンで切り替える
- 選んだ見た目は端末ごとに localStorage へ保存。2人がそれぞれ好きな方を選べる
- かわいい版はお花のイラストとピンク系の配色。お花はSVGで描いており画像ファイルは使わない
- 色や角丸はすべてCSS変数にしてあるので、見た目を足すときは変数を増やす
