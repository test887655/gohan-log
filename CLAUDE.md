...
- 「シンプル」「大人」「かわいい」「水族館」「ダーク」の5種類。
  ...
  - 水族館：水色系。壁紙は海の生き物のイラスト（images/aquarium-bg.png）を散らしたもの。
    元の絵は背景を抜いて生き物ごとに切り出し、小さくして並べた。
    画像は2倍の大きさ（800px）で作り、--page-pattern-size で 400px に縮めて細かく見せる。
    お花は出さない。画像を差し替えたら sw.js の CACHE も上げる
