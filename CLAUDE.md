...
- 3日に一度は星が出て、ボーナス10ポイント（キラキラの3＋10で13ポイント）。
  3日ずつの組に分け、その3日のどの日に出すかをでたらめに決める（ペースは3日に1回のまま。
  間が1日のことも5日のこともある）。時間帯は前の星から1つか2つ進めるので、
  朝・昼・夜がでたらめに回り、同じ時間帯が2回続くことはない（points.js の bonusSlot）。
  以前は「その日の最初のひとつ」を星にしていたが、朝に開く人はいつも朝になってしまった。
  2人とも同じになるよう、日付そのものから決める（端末ごとの乱数は使わない）。
  星の時間帯に開けなかったときは、その日のうちの次のキラキラが星になる
